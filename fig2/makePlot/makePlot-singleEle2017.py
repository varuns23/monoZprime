...
h_sig = get_root_object(fIn, "Mx1_Mv1000")
h_sig.SetLineColor(rt.kRed)
...
texLumi.Draw()
texExtra1 = rt.TLatex(0.17,0.85, "Single electron")
texExtra1.SetNDC()
texExtra1.SetTextFont(42)
texExtra1.SetTextSize(0.045)
texExtra1.Draw()
texExtra2 = rt.TLatex(0.17,0.765, "validation region")
texExtra2.SetNDC()
texExtra2.SetTextFont(42)
texExtra2.SetTextSize(0.045)
texExtra2.Draw()

leg = rt.TLegend(0.45, 0.58, 0.88, 0.91)
leg.SetFillStyle(0)
leg.SetBorderSize(0)
leg.SetTextFont(42)
