...
# with command line options: step2 --mc --eventcontent AODSIM,DQM --runUnscheduled --datatier AODSIM,DQMIO --conditions 80X_mcRun2_asymptotic_2016_TrancheIV_v6 --step RAW2DIGI,RECO,EI,DQM:DQMOfflinePOGMC --nThreads 4 --era Run2_2016 --filein file:/hdfs/store/user/gomber/MonoZprime_DIGI/MonoZprime_Mx10_Mv100_DIGI-submit_step1_DIGIPREMIX_S2_DATAMIX_L1_DIGI2RAW_HLT/submit_step1_DIGIPREMIX_S2_DATAMIX_L1_DIGI2RAW_HLT-MonoZprime_Mx10_Mv100_GENSIM2-0036.root --fileout file:test_AODSIM.root -n 10
...
process.DQMoutput = cms.OutputModule("DQMRootOutputModule",
    ...
    fileName = cms.untracked.string('inDQM$outputFileName'),
