...
h_dat.SetMarkerStyle(rt.kFullCircle)
h_dat.SetLineColor(rt.kBlack)
...
#h_dat.SetMarkerSize(1.2)
#h_dat.SetMarkerColor(rt.kBlack)
#h_dat.Draw("E1P same")
gr_dat.SetMarkerStyle(20)
gr_dat.SetMarkerSize(1.5)
gr_dat.Draw("PE1 same")
...
legend.AddEntry(gr_dat, "Data", "lep")
...
ratio_nom.SetMarkerStyle(20)
ratio_nom.SetMarkerSize(1.3)
ratio_nom.Draw("E1")
ratio_nom.SetTitle("")

ratio_nom.GetYaxis().SetTitle("Data/Bkg")
...
line = ROOT.TLine(0.0, 1.0, 10.0, 1.0)
line.SetLineColor(14) # light gray
...
c1.SaveAs("plots/prefit-%s_paper.pdf"%second_dir)
